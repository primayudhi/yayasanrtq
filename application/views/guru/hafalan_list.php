                  ...
                  <?php foreach($setor_hafalan as $row) { ?>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <button class="btn btn-primary btn-lg hidden-print" onclick="myFunction()"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>
                            <a href="<?php echo site_url('Guru/ubah_hafalan/' . $row->id_setorhafalan) ?>" class="btn btn-sm btn-warning">
