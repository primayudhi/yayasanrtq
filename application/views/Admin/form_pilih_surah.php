                  ...
                  <div class="body">
                    <div class="list-group">
                        <?php foreach($data_surah as $surah){ 
                            $persen = $this->Admin_model->surah_by_murid($id_murid, $surah->id_surah)->persen;
                            ?>
                            <!-- id murid, id surah, id setor -->
                            
                            <a href="<?php echo site_url('Admin/hafalan_ayat/'.$id_murid.'/'.$surah->id_surah.'/'.$id_setorhafalan); ?>" class="list-group-item">
